...
% Tracker4 = X_Rot_Vive(2:end-1,1);
% Tracker5 = Y_Rot_Vive(2:end-1,1);
% Tracker6 = Z_Rot_Vive(2:end-1,1);
% Tracker7 = W_Rot_Vive(2:end-1,1);

Tracker4 = X_Rot_Vive(2:1400-1,1);
Tracker5 = Y_Rot_Vive(2:1400-1,1);
Tracker6 = Z_Rot_Vive(2:1400-1,1);
Tracker7 = W_Rot_Vive(2:1400-1,1);
...
wandO1 = Vicon_Interp_O(2:1400-1,1);
wandO2 = Vicon_Interp_O(2:1400-1,2);
wandO3 = Vicon_Interp_O(2:1400-1,3);
wandX1 = Vicon_Interp_X(2:1400-1,1);
wandX2 = Vicon_Interp_X(2:1400-1,2);
wandX3 = Vicon_Interp_X(2:1400-1,3);
wandY11 = Vicon_Interp_Y(2:1400-1,1);
wandY12 = Vicon_Interp_Y(2:1400-1,2);
wandY13 = Vicon_Interp_Y(2:1400-1,3);
